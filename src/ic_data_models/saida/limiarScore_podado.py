...
# Definição da base de regras (podada)
rules = []
...
def getLimiarScore_Podado(coScoreTotal, IC, subjectScoreTotal, isNormalizado=False):
    sim.input["ic"] = IC
...
if __name__ == "__main__":
    print("LimiarScore: ", getLimiarScore_Podado(
        1, # IC
        1, # coScoreTotal
        1, # subjectScoreTotal
        True # isNormalizado  
