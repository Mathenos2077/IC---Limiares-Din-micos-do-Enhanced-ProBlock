...
# Definição da nova base de regras (podada)
rules = []
...
rules.append(ctrl.Rule(ic[icC[0]] & coEscore[coEscoreC[2]], limiarScore[limiarScoreC[0]]))
...
rules.append(ctrl.Rule(ic[icC[0]] & coEscore[coEscoreC[4]], limiarScore[limiarScoreC[1]]))

# Grupo 2: ICco = 1
rules.append(ctrl.Rule(ic[icC[1]] & coEscore[coEscoreC[0]], limiarScore[limiarScoreC[1]]))
rules.append(ctrl.Rule(ic[icC[1]] & coEscore[coEscoreC[1]], limiarScore[limiarScoreC[2]]))
rules.append(ctrl.Rule(ic[icC[1]] & coEscore[coEscoreC[2]], limiarScore[limiarScoreC[2]]))
...
rules.append(ctrl.Rule(ic[icC[1]] & coEscore[coEscoreC[4]], limiarScore[limiarScoreC[3]]))

# Grupo 3: ICco = 2
rules.append(ctrl.Rule(ic[icC[2]] & coEscore[coEscoreC[0]], limiarScore[limiarScoreC[3]]))
...
rules.append(ctrl.Rule(ic[icC[2]] & coEscore[coEscoreC[2]], limiarScore[limiarScoreC[4]]))
rules.append(ctrl.Rule(ic[icC[2]] & coEscore[coEscoreC[3]], limiarScore[limiarScoreC[4]]))
rules.append(ctrl.Rule(ic[icC[2]] & coEscore[coEscoreC[4]], limiarScore[limiarScoreC[5]]))

# Grupo 4: ICco = 3
rules.append(ctrl.Rule(ic[icC[3]] & coEscore[coEscoreC[0]], limiarScore[limiarScoreC[5]]))
...
rules.append(ctrl.Rule(ic[icC[3]] & coEscore[coEscoreC[2]], limiarScore[limiarScoreC[6]]))
rules.append(ctrl.Rule(ic[icC[3]] & coEscore[coEscoreC[3]], limiarScore[limiarScoreC[6]]))
...
# Grupo 5: ICco = 4
rules.append(ctrl.Rule(ic[icC[4]] & coEscore[coEscoreC[0]], limiarScore[limiarScoreC[7]]))
...
rules.append(ctrl.Rule(ic[icC[4]] & coEscore[coEscoreC[2]], limiarScore[limiarScoreC[8]]))
rules.append(ctrl.Rule(ic[icC[4]] & coEscore[coEscoreC[3]], limiarScore[limiarScoreC[8]]))
rules.append(ctrl.Rule(ic[icC[4]] & coEscore[coEscoreC[4]], limiarScore[limiarScoreC[8]]))
...
def getLimiarScore_Podado_v2(coScoreTotal, IC, subjectScoreTotal, isNormalizado=False):
    sim.input["ic"] = IC
    sim.input["coEscore"] = coScoreTotal
    sim.input["subjectScore"] = subjectScoreTotal
    sim.compute()
...
if __name__ == "__main__":
    print("LimiarScore: ", getLimiarScore_Podado_v2(
        1, # IC
        1, # coScoreTotal
        1, # subjectScoreTotal
        True # isNormalizado  
